  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden px-4">
      <div className="absolute inset-0 -z-10">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_left,oklch(0.55_0.22_280/15%)_0%,transparent_60%)]" />
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_right,oklch(0.75_0.15_55/10%)_0%,transparent_60%)]" />
        <motion.div
          animate={{ y: [0, -20, 0], opacity: [0.3, 0.5, 0.3] }}
          transition={{ duration: 6, repeat: Infinity, ease: 'easeInOut' }}
          className="absolute top-1/4 left-1/4 w-64 h-64 rounded-full bg-[oklch(0.55_0.22_280/8%)] blur-3xl"
        />
        <motion.div
          animate={{ y: [0, 20, 0], opacity: [0.2, 0.4, 0.2] }}
          transition={{ duration: 8, repeat: Infinity, ease: 'easeInOut', delay: 2 }}
          className="absolute bottom-1/4 right-1/4 w-80 h-80 rounded-full bg-[oklch(0.75_0.15_55/8%)] blur-3xl"
        />
      </div>
      ...
      >
        <div className="glass-strong rounded-2xl p-8 shadow-2xl">
          ...
          <p className="text-muted-foreground text-center text-sm mb-7">Sign in to continue your journey</p>
          ...
          <div className="grid grid-cols-1 gap-3 mb-6">
            <Button
              ...
              className="h-10 border-border hover:bg-muted/50 gap-2"
            >
              {oauthLoading === 'google' ? (
